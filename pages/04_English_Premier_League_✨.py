...
df = pd.read_csv("D:/EPITA/data-reporting-visualisation/Final_Project/Data/english premier league data.csv")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("This chart shows the total goals scored by the home team and away team in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("This chart shows the total match excitement on each year in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("We can clearly see that number of matches having 1 Home team goal is not so far from 2. So, normally two goals .This chart shows the distribution of the home team goals scored in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("We can clearly see that number of matches having 1 Away team goal is  so far from 2. So, normally 0 - 1 .This chart shows the distribution of the away team goals scored in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("This chart shows the total shot on target on each year in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("This chart shows the total shot off target on each year in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("This chart shows the minimum, maximum and mean of the total fouls on each year in the English Premier League.")
...
st.plotly_chart(fig)
with st.expander('See Explanation'):
    st.markdown("This chart shows the total cards on each year in the English Premier League.")
